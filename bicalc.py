#Bicalc.py is created to simplify mathematical conversions and all functions are described in line 6
# Main function receives user's function choise and calls needed function
def main_1():
    print("\n" * 3)
    print("Hello dear user, please choose what you want to get" + "\n")
    print("\n" + "Current choice:\n" + "For conversion of numbers between different numerical systems, print conv")
    user_func_choice = input()
    user_func_choice = user_func_choice.lower()
    #Immitation of work to make proggram look more complicated than it is
    print("\n" + "Thank you, processing" + "\n")
    print_value_useless = 5
    for count in range(5):
        print("." * print_value_useless + "\n")
        print_value_useless -= 1
    if user_func_choice == "conv":
